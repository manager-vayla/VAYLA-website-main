...
<button className="bg-primary text-midnight heading-bold py-4 rounded-xl flex items-center justify-center gap-2 shadow-[0_4px_20px_rgba(112,243,216,0.3)]">
                        Explore VAYLA Arena <span className="material-symbols-outlined text-sm">arrow_forward</span>
</button>
<button className="bg-transparent backdrop-blur-md border-2 border-primary text-primary heading-bold py-4 rounded-xl hover:bg-primary/5 transition-colors">
                        Token Utility
                    </button>
</div>
</div>
...
<div className="logo-carousel-item snap-center">
...
<span className="heading-bold text-3xl uppercase tracking-tighter">VAYLA</span>
</div>
...
<a className="social-icon-enhanced" href="#">
