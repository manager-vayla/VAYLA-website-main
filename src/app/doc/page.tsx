...
import WhitepaperButton from '@/components/atoms/WhitepaperButton';
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="grid gap-6">
                            <div className="glass-card p-8 rounded-2xl glow-subtle text-left border border-white/10 hover:border-primary/30 transition-all duration-300">
                                ...
                                <WhitepaperButton className="w-full py-4 bg-primary text-midnight font-bold rounded-xl hover:bg-primary/90 transition-colors flex items-center justify-center gap-2 font-averta" />
                            </div>
