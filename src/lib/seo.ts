...
export const ROUTE_SEO: Record<string, { title: string; description: string; index?: boolean }> = {
  ...
  '/vaults': { title: 'VAYLA Arena Catalogue — Preview', description: 'Explore the VAYLA Arena catalogue interface with illustrative creator and campaign data.' },
  '/marketplace': { title: 'VAYLA Marketplace — Preview', description: 'Preview the VAYLA marketplace interface with illustrative listings. Trading is not available.' },
  ...
  '/dashboard': { title: 'VAYLA Dashboard — Preview', description: 'Preview the VAYLA dashboard interface with illustrative portfolio, reward and performance data.' },
