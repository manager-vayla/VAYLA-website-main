...
import festivalImg from '@/assets/festival_vayla.png';
...
export default function StitchArenaLayer() {
    return (
        <section className="px-6 py-24 bg-charcoal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto space-y-8 md:space-y-0">
                <div className="split-card h-full">
                ...
                <div className="split-card h-full">
                    <div className="relative w-full h-[180px] overflow-hidden">
                        <Image src={festivalImg} alt="Festival" className="w-full h-full object-cover" unoptimized />
