      ...
      <div className="wrap">
        <div className="f-grid">
          <div className="f-brand">
            ...
            <p className="lede">The public information hub for VAYLA Arena: a Beta Web3 music fandom platform for creator support, voting, creation and participation-based features.</p>
          </div>
          <div className="f-col">
            <h6>Platform</h6>
            <ul>
              <li><Link to="/vaults">Arena catalogue</Link></li>
          ...
          <div className="f-col f-col--legal">
            ...
            <ul>
              ...
              <li><Link to="/legal" className="legal-all-link">All legal</Link></li>
            </ul>
          </div>
        </div>
        <div className="f-bottom">
          <span className="f-copy">© 2026 VAYLA | OFFICIAL INFORMATION HUB</span>
