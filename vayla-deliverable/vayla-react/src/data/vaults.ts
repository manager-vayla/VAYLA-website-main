...
function makeMonthly(base: number, drift: number) {
  return months.map((m, i) => ({
    m,
    tvl: Math.round(base * (1 + drift * i) * (0.96 + i * 0.01)),
    revenue: Math.round(base * 0.04 * (1 + drift * i) * (0.92 + i * 0.015)),
  }));
}

/** Illustrative data restored with the former interface. It is not live market data. */
export const VAULTS: Vault[] = [
  {
    ...
    revenue: [
      { source: 'Streaming', usd: 142_000, share: 0.34 }, { source: 'Drops & Merch', usd: 98_000, share: 0.24 },
      { source: 'Live & Touring', usd: 121_000, share: 0.29 }, { source: 'IP & Sync', usd: 53_000, share: 0.13 },
    ],
  ...
  },
  {
    ...
    revenue: [
      { source: 'YouTube AdSense', usd: 78_000, share: 0.18 }, { source: 'Streaming Licenses', usd: 162_000, share: 0.38 },
      { source: 'Merch & Print', usd: 84_000, share: 0.20 }, { source: 'IP Licensing', usd: 102_000, share: 0.24 },
    ],
  ...
  },
  {
    ...
    revenue: [
      { source: 'Game Sales', usd: 88_000, share: 0.55 }, { source: 'DLC', usd: 28_000, share: 0.18 },
      { source: 'Tournaments', usd: 16_000, share: 0.10 }, { source: 'Merch', usd: 27_000, share: 0.17 },
    ],
    monthly: makeMonthly(1_900_000, 0.08),
    fanTier: [
      { name: 'Player', min: 100, perks: ['Pro-rata yield', 'Beta keys'] }, { name: 'Pro', min: 1500, perks: ['Tourney seat', 'Discord VIP'] },
    ],
  ...
  },
  {
    ...
    revenue: [
      { source: 'Production Royalties', usd: 220_000, share: 0.50 }, { source: 'Sample Licensing', usd: 78_000, share: 0.18 },
      { source: 'Beat Marketplace', usd: 65_000, share: 0.15 }, { source: 'Mentorship', usd: 75_000, share: 0.17 },
    ],
    monthly: makeMonthly(9_100_000, 0.02),
    fanTier: [
      { name: 'Crate Digger', min: 200, perks: ['Pro-rata yield'] }, { name: 'A&R', min: 5000, perks: ['Unreleased drops', 'Studio sessions'] },
    ],
  ...
  },
  {
    ...
    revenue: [
      { source: 'Prize Pools', usd: 145_000, share: 0.31 }, { source: 'Sponsorships', usd: 195_000, share: 0.42 },
      { source: 'Content Rev', usd: 60_000, share: 0.13 }, { source: 'Merch', usd: 65_000, share: 0.14 },
    ],
    monthly: makeMonthly(5_200_000, 0.04),
    fanTier: [
      { name: 'Rookie', min: 100, perks: ['Pro-rata yield'] }, { name: 'Sixth Man', min: 3000, perks: ['Match-day chat', 'Roster votes'] },
  ...
  },
  {
    ...
    revenue: [
      { source: 'Distribution', usd: 92_000, share: 0.38 }, { source: 'Streaming Licenses', usd: 78_000, share: 0.32 },
      { source: 'Festival Awards', usd: 22_000, share: 0.09 }, { source: 'IP Development', usd: 50_000, share: 0.21 },
    ],
    monthly: makeMonthly(3_000_000, 0.03),
    fanTier: [
      { name: 'Audience', min: 200, perks: ['Pro-rata yield'] }, { name: 'Producer', min: 5000, perks: ['Screening invites', 'EP credit'] },
    ],
